const sentence = () => {
    ...
    let word1 = phrases[0][0] < phrases[1][1] ? " before" : phrases[0][0] > phrases[1][0] ? " after" : " while";
    let word2 = (phrases[2][0] - phrases[0][0]) * (phrases[1][0] - phrases[0][0]) > 0 ? " and" :
    ...
    sentence += `  Calculate the ${phrases[3][3]}.`;
    return sentence;
}
